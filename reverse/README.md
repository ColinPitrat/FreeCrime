...
ACT - Palette for 8 bits raw graphics (.RAT)
DAT - Configuration (resolution, volume, language, etc...)
RAT - Raw graphics in 8 bits (palette in .ACT)
RAW - Raw graphics in 24 birs
